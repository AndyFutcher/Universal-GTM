...
function() { // Mirror Action Events On Facebook
    if(typeof window.fbq=="function"){ // Check Facebook Pixel Is Declared (should always be based on GTM Setup Tag)
		...
		fbq('track', "PageView"); // Contact Interaction

		// Template Choices
		//fbq('trackCustom', _FB['event'].replace(' ',''), {content_category: _FB['category'], content_name: _FB['label'], value: _FB['value']}); // Custom Events
